...
// Set the border of the all the hr elements to "1px solid tomato"
   let border = allHrsArray.forEach((ele) => ele.style.border = '1px solid tomato');
// Change the background of all the hr to "antiquewhite" using for of loop.
   let background =  allHrsArray.forEach((ele) => ele.style.backgroundColor = 'antiquewhite');  
// Change the 'border-radius' of all the hr to "5px" using array.
   let radius =  allHrsArray.forEach((ele) => ele.style.borderRadius = '5px'); 
...
// Change the border of all the hr element from solid to dashed type
   let borderAll = allHrsArray.forEach((ele) => ele.style.border = 'dashed'); 
...
let box2 = document.querySelector('.two').append('Append inserts as last child');

   
// Select box 3 and prepend a new paragraph element with content "Prepend inserts as first child" just before hr element.
let box3 = document.querySelector('.three').prepend('Prepend inserts as first child');
...
// Using the remove classList proeprty remove the class `awesome-box` from box 4
   ...
   document.querySelector('.two').classList.remove('awesome-box');
